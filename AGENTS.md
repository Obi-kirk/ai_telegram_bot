...
- Тесты: 38 шт (tests/) — роли, валидация, sanitize, RAGAnswerService, история диалога, кэш, каталог/корзина/заказы; используют реальную БД ai_bot, чистят свои данные, TESTING=1 включает NullPool.
